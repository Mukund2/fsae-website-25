...
function SponsorCard({
  ...
  const card = (
    <div
      ...
      className={`group flex flex-col items-center justify-center border border-border/50 bg-surface ${tierMeta.cardSize} hover:border-[#C8952E]/40 hover:shadow-[0_0_24px_rgba(200,149,46,0.08)]`}
    >
      {inner}
    </div>
  );
...
function TierSection({ tier }: { tier: string }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16 md:py-24">
      {/* Tier heading */}
      <div data-reveal>
        <h2 className="font-mono text-sm uppercase tracking-[0.25em] text-[#C8952E] md:text-base">
          {meta.label}
        </h2>
        <div className="mt-3 h-px w-full bg-[#C8952E]/30" />
      </div>
