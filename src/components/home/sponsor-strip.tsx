...
const SPONSORS: Sponsor[] = [
  ...
  { name: "Don Beal", logo: "/images/sponsors/don-beal.svg" },
  ...
  { name: "Glenrock Builders", logo: "/images/sponsors/glenrock.svg" },
...
export function SponsorStrip() {
  return (
    <section className="relative w-full pt-10 pb-20 overflow-hidden" style={{ background: "#F5F5F5" }}>
