...
export const timeline: TimelineEvent[] = [
  ...
  {
    year: 2015,
    title: "SR-7 / First in 2015 FSAE",
    description:
      "Placed 1st in the 2015 FSAE Competition with SR-7.",
    image: "/images/history/sr7-2015.jpg",
  },
  {
    year: 2015,
    title: "Spartan Racing Electric Born",
    description:
      "In the summer of 2015 Spartan Racing initiated its plan to create a sub-division of the Spartan Racing organization, Spartan Racing Electric. This division was able to design and manufacture an electric iteration of the Spartan Racing vehicle for the first time in the organization's history.",
    image: "/images/history/sre-electric-2015.jpg",
  },
  {
    year: 2021,
    title: "SRE-5",
